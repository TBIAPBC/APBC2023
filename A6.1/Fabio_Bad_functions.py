...
# returns all accessible border tiles of a map and it´s paths
...
# Converts the coordinates of two two tiles to a direction coordinate (for all the coordinates of the given path)
def Coords2coorDirs(coords, coorDirs):
    for i in range(len(coords)-1):
            start = coords[i]
            end = coords[i+1]
            coorDirs.append((end[0]-start[0], end[1]-start[1]))
    return coorDirs

# Converts directions as coordinates to directions as objects of class Directions
